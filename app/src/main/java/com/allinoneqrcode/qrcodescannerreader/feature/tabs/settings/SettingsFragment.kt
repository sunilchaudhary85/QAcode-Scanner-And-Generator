...
import com.allinoneqrcode.qrcodescannerreader.di.barcodeDatabase
...
import com.allinoneqrcode.qrcodescannerreader.extension.packageManager
import com.allinoneqrcode.qrcodescannerreader.extension.showError
import com.allinoneqrcode.qrcodescannerreader.feature.common.dialog.DeleteConfirmationDialogFragment
import com.allinoneqrcode.qrcodescannerreader.feature.tabs.settings.camera.ChooseCameraActivity
import com.allinoneqrcode.qrcodescannerreader.feature.tabs.settings.formats.SupportedFormatsActivity
import com.allinoneqrcode.qrcodescannerreader.feature.tabs.settings.permissions.AllPermissionsActivity
import com.allinoneqrcode.qrcodescannerreader.feature.tabs.settings.search.ChooseSearchEngineActivity
import com.allinoneqrcode.qrcodescannerreader.feature.tabs.settings.theme.ChooseThemeActivity
...
class SettingsFragment : Fragment(), DeleteConfirmationDialogFragment.Listener {
    ...
    private fun handleButtonClicks() {
        ...
        button_privacy.setOnClickListener { showPrivacy() }
    }
    ...
    private fun showPrivacy() {
       /* val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.freeprivacypolicy.com/live/2262533f-eee7-44ce-a0b6-ece398793955"))
        webview.loadUrl("https://www.freeprivacypolicy.com/live/2262533f-eee7-44ce-a0b6-ece398793955")
